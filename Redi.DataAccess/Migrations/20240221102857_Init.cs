        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Card_AspNetUsers_ClientEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DeliverierId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DeliveryType = table.Column<int>(type: "int", nullable: false),
                    OriginAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OriginStateCountry = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OriginPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OriginOthers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationStateCountry = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DestinationOthers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PackageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PackageWeight = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorthOfItems = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_AspNetUsers_ClientEntityId",
                        column: x => x.ClientEntityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryStates_Deliveries_DeliveryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_DeliverierId",
                table: "Deliveries",
                column: "DeliverierId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStates_DeliveryId",
                table: "DeliveryStates",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaction_ClientEntityId",
                table: "Transaction",
                column: "ClientEntityId");
        }
